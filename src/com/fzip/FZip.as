...
package com.fzip
{
     ...
     * loaded successfully.
     *
     * @eventType deng.com.fzip.FZipEvent.FILE_LOADED
     */
    [Event(name="fileLoaded", type="com.fzip.FZipEvent")]

    /**
     * Dispatched when an error is encountered while parsing a
     * ZIP Archive.
     *
     * @eventType deng.com.fzip.FZipErrorEvent.PARSE_ERROR
     */
    [Event(name="parseError", type="com.fzip.FZipErrorEvent")]
